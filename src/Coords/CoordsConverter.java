...
public class CoordsConverter implements coords_converter
{
	...
	public double[] azimuth_elevation_dist(Point3D gps0, Point3D gps1) 
	{
		...
		double sinDiffLat        = Math.sin(diffLat/2) ; /*sin(־”ֿ†/2)*/
		double sinDiffLon        = Math.sin(diffLon/2) ;  /* sin(־”־»/2)*/
...
//	    
	...
	//Formula:	azimuth = atan2( sin ײ¾ג€�ײ¾ֲ» ׳’ג€¹ג€¦ cos ײ¿ג€ 2 , cos ײ¿ג€ 1 ׳’ג€¹ג€¦ sin ײ¿ג€ 2 ׳’ֻ†ג€™ sin ײ¿ג€ 1 ׳’ג€¹ג€¦ cos ײ¿ג€ 2 ׳’ג€¹ג€¦ cos ײ¾ג€�ײ¾ֲ» )
...
//System.out.println("AZIMUTH IS   ---->  "+coords.azimuth_elevation_dist(gps0, gps1)[0] + "ײ²ֲ°" );
//System.out.println("ELEVATION IS ---->  "+coords.azimuth_elevation_dist(gps1, gps0)[1] + "ײ²ֲ°");
